...
@section('content')
    ...
    <div class="content container pt-0">
        ...
        <form method="post" action="{{route('putBook',$book['id'])}}" class="card">
            {{ csrf_field() }}
                    ...
                    <div class="col-lg-10">
                        <select required name="author" class="form-control" id="">
                            ...
                            @foreach($authors['items'] as $author)
                                <option @if($book['author']['id'] == $author['id']) selected @endif value="{{$author['id']}}">{{$author['first_name'].' '.$author['last_name']}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
            ...
            <div class="card-body p-2 border-bottom">
                <div class="row ">
                    ...
                    <div class="col-lg-10">
                        ...
                        value="{{ \Carbon\Carbon::parse($book['release_date'])->format('Y-m-d\TH:i')}}">
                    </div>
                </div>
            </div>
            <div class="card-body p-2 border-bottom">
                <div class="row ">
                    ...
                    <div class="col-lg-10">
                        <textarea required name="description" class="form-control" id="" cols="30" rows="4">{{$book['description']}}</textarea>
                    </div>
                </div>
            </div>
            <div class="card-body p-2 border-bottom">
                <div class="row ">
                    ...
                    <div class="col-lg-10">
                        <input required type="text" name="isbn" class="form-control" value="{{$book['isbn']}}" id="mask_isbn">
                    </div>
                </div>
            </div>
            <div class="card-body p-2 border-bottom">
                <div class="row ">
                    ...
                    <div class="col-lg-10">
                        <input required type="text" name="format" value="{{$book['format']}}" class="form-control" >
                    </div>
                </div>
            </div>
            <div class="card-body p-2 border-bottom">
                <div class="row ">
                    ...
                    <div class="col-lg-10">
                        <input required type="number" min="1" step="1" value="{{$book['number_of_pages']}}" name="number_of_pages" class="form-control" >
                    </div>
                </div>
            </div>
