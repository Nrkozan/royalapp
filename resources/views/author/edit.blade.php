...
@section('content')
    ...
    <div class="content container pt-0">
        ...
        <form method="post" action="{{route('putAuthor',$author['id'])}}" class="card">
            {{ csrf_field() }}
            <div class="card-body p-2 border-bottom">
                <div class="row ">
                    <label class="col-lg-2 col-form-label">Firt Name:</label>
                    <div class="col-lg-10">
                        <input required value="{{$author['first_name']}}" type="text" name="first_name" class="form-control" >
                    </div>
                </div>
            </div>
            <div class="card-body p-2 border-bottom">
                <div class="row ">
                    ...
                    <div class="col-lg-10">
                        <input required value="{{$author['last_name']}}" type="text" name="last_name" class="form-control" >
                    </div>
                </div>
            </div>
            <div class="card-body p-2 border-bottom">
                <div class="row ">
                    ...
                    <div class="col-lg-10">
                        <input type="datetime-local" value="{{date('Y-m-d\TH:i', strtotime($author['birthday']))}}" class="form-control" name="birthday">
                    </div>
                </div>
            </div>
            <div class="card-body p-2 border-bottom">
                <div class="row ">
                    ...
                    <div class="col-lg-10">
                        <textarea name="biography" id="" cols="30" class="form-control" rows="3">{{$author['biography']}}</textarea>
                    </div>
                </div>
            </div>
            <div class="card-body p-2 border-bottom">
            ...
            <div class="card-body p-2 border-bottom">
                <div class="row ">
                    ...
                    <div class="col-lg-10">
                        <input required type="text" value="{{$author['place_of_birth']}}"  name="place_of_birth" class="form-control" >
                    </div>
                </div>
            </div>
